...
def main(prefix,
         sitemodel=os.path.join(MYPATH, "../params/site_predictor.pkl"),
         propmodel=os.path.join(MYPATH, "../params/prop_predictor.pkl"),
         ligpdb='',
    ...
    args = predict_site(prednpz, modelname=sitemodel, recxyz=recxyz, ligxyz=ligxyz, debug=False)
    if not args:
        return
